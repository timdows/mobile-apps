wallmobileApp.controller("ScenesCtrl", function($scope, $http, $timeout, $ionicTabsDelegate) {
    ...
    $scope.updateStatusses = function() {
        angular.forEach($scope.groups, function(group) {
            angular.forEach(group.items, function(item) {
                var url = 'http://10.0.0.15/port_3480/data_request?id=status&output_format=json&DeviceNum=' +
                    item.deviceNum;
    ...
    $scope.sceneClick = function(scene) {
        ...
        var url = "http://10.0.0.15/port_3480/data_request?id=lu_action&output_format=json&DeviceNum=" +
            scene.deviceNum +
